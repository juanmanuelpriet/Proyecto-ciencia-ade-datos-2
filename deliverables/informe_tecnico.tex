...
\begin{titlepage}
  ...
  \begin{tabular}{rl}
    \textbf{Autores:} & Juan Manuel Prieto Corredor \\
                     & Slendy Grisales Rueda \\[0.2cm]
    \textbf{Profesor:} & Sergio Amortegui \\[0.2cm]
    \textbf{Fecha:}   & \today \\[0.2cm]
    \textbf{Versión del Sistema:} & v1.0.0 \\[0.2cm]
    \textbf{Repositorio:} & \texttt{Proyecto-ciencia-ade-datos-2} \\
  \end{tabular}
...
\begin{figure}[H]
  ...
  \caption{Diagrama Entidad-Relación del esquema de churn.}
